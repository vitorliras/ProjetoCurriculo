  ...
  return (
    ...
    <div className='template1-parent'>
      ...
      <div className='objective mt-3'>
        <h3 style={{backgroundColor: 'gray', padding:8}}>Objetivo</h3>
        <hr />
        <p>{user.objetivo}</p>
      </div>
      ...
      <div className='education mt-3'>
        <h3 style={{backgroundColor: 'gray', padding:8}} >Educação</h3>
        <hr />
      ...
      <div className='expirience mt-3'>
        <h3 style={{backgroundColor: 'gray', padding:8}} >Experiência</h3>
        <hr />
      ...
      <div className='projetos mt-3'>
        <h3 style={{backgroundColor: 'gray', padding:8}} >Projetos</h3>
        <hr />
      ...
      <div className='projetos mt-3'>
        <h3 style={{backgroundColor: 'gray', padding:8}} >Competências</h3>
        <hr />
